    ...
    <div className="legal-layout">
      ...
      <article className="legal-document app-card legal-layout__content">
        ...
        <section id="accessibility-contact">
          ...
          <p>אם נתקלתם בקושי, אפשר לפנות דרך <a href="/contact">טופס יצירת הקשר</a> ולבחור בנושא נגישות. נשמח לקבל תיאור של הפעולה שניסיתם לבצע, כתובת העמוד, הדפדפן והטכנולוגיה המסייעת שבה השתמשתם. פרטי איש או אשת הקשר לנגישות ודרכי הפנייה הישירות יפורסמו כאן לפני פתיחת השירות לציבור.</p>
        </section>
        <section>
