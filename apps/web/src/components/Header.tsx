...
// Owned by ApplicationRouter, outside the replaceable page content.
export function Header({ loadSession = false }: { loadSession?: boolean } = {}) {
  ...
  return (<header id="site-header" className="site-header" ref={header} dir="rtl" data-session-pending="" aria-busy="true">
    <div className="site-header-inner">
      ...
      <nav id="main-nav" className="site-header-nav" aria-label="ניווט ראשי">
        ...
        <a data-site-audience="guest" data-site-page="login" className="site-header-mobile-login" href="/login">כניסה למערכת</a>
      </nav>
      <div className="site-header-actions">
        <a data-site-audience="guest" data-site-page="login" className="site-header-login" href="/login">כניסה</a>
        <ButtonLink data-site-audience="guest" data-site-page="start" className="site-header-cta" size="sm" href="/start">מתחילים לגייס <span aria-hidden="true">←</span></ButtonLink>
