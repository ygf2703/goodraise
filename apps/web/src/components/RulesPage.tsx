...
export function RulesPage() {
  return (<section id="page-rules" className="page-shell">
        <article className="legal-hero app-card app-card--elevated">
          <h1>תנאי שימוש ותקנון השתתפות</h1>
        ...
        <div className="legal-layout">
          ...
          <article className="legal-document app-card legal-layout__content">
            ...
            <section id="rules-section-4">
              <h2>4. שוויון, תיקונים וחריגים</h2>
