...
test("summarizes unique valid Google Sheets donation records", () => {
  const summary = summarizeGoogleSheetsRecords([
    { id: "a-1", created_at: "25/08/26 10:00", total: "₪10,000", charged_success: "TRUE" },
    { id: "a-2", created_at: "25/08/26 10:01", total: "250.50", charged_success: "TRUE" },
    { id: "a-2", created_at: "25/08/26 10:01", total: "250.50", charged_success: "TRUE" },
    { id: "not-charged", created_at: "25/08/26 10:02", total: "₪30,000", charged_success: "FALSE" },
    { id: "bad", created_at: "", total: "100" },
  ]);

  assert.deepEqual(summary, { rowCount: 2, total: 10250.5, invalidRows: 1, unchargedRows: 1 });
});
