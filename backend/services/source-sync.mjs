...
import { SourceConfigValidationError, validateSourceConfig } from "./source-security.mjs";
import {
  appendAuditEvent,
...
const GOOGLE_SHEETS_NORMALIZER_VERSION = "2026-08-26-redash-empty-header-alignment-v10";
...
export async function refreshAdminSource(request, scope = {}) {
  ...
  try {
    ...
    return jsonResponse(error instanceof SourceConfigValidationError ? 400 : 502, {
