...
export function buildDatasetRow(record) {
...
async function getPostgresPool() {
  if (!hasConfiguredRelationalIngest()) throw new IngestHttpError(503, "GOODRAISE_DATABASE_URL is not configured on the server.");
...
/** @param {{ organizationIdentifier: string, campaignIdentifier: string, sourceLabel?: string, importedBy?: string, requestReference?: string, fetchedAt?: string, records?: Record<string, unknown>[], replaceExternalSnapshot?: boolean }} options */
